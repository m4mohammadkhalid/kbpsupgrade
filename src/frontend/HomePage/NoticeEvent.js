...
const NoticeEvent = () => {
    return (
        <>
            ...
            <section style={{ backgroundColor: '#F0FAF5',paddingTop:'60px' }} className="instructor-section">
                <div className="auto-container">
                    <div className="row clearfix">
                        <div className="instructor-column col-lg-4 col-md-12 col-sm-12">
                            <div style={{height:'400px',borderRadius:'20px'}} className="inner-column wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
                                <h4>Notice</h4>
                                <marquee behavior="scroll" align="absup" direction="up" scrollamount={6} scrolldelay={150} height={300} onMouseOver="this.stop();" onMouseOut="this.start();">
...
Lorem Ipsum is simply dummy text of the printing</Link><br /><br />
                        ...
                        <div className="instructor-column col-lg-4 col-md-12 col-sm-12">
                            <div style={{height:'400px', borderRadius:'20px'}} className="inner-column wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
                                <h4>LANoticeEvent NEWS</h4>
                                <marquee behavior="scroll" align="absup" direction="up" scrollamount={6} scrolldelay={140} height={300} onMouseOver="this.stop();" onMouseOut="this.start();">
                                    <img style={{ height: '30px', width: '36px' }} src="http://www.skitm.edu.in/new.gif" alt="khalid"  />
                                    <Link to="notice/BBA.pdf" style={{ color: 'red', textDeclaration: 'nonetarget:_blank' }}> Lorem Ipsum is simply dummy text of the printing.</Link><br /><br />
                                    <img style={{ height: '30px', width: '36px' }} src="http://www.skitm.edu.in/new.gif" alt="khalid"  />
                                    <Link to="notice/B.Tech 3rd sem G  March-2021.pdf" style={{ color: 'red', textDeclaration: 'nonetarget:_blank' }}> Lorem Ipsum is simply dummy text of the printing</Link><br /><br />
