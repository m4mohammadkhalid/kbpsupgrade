            ...
            <div className="card-body">
              <ul className="activity-feed">
                <li className="feed-item">
                  ...
                  <span className="feed-text"><Link>John Doe</Link> won 1st place in <Link>"Chess"</Link></span>
                </li>
                <li className="feed-item">
                  <div className="feed-date">Mar 21</div>
                  <span className="feed-text"><Link>Justin Lee</Link> participated in <Link to="invoice.html">"Carrom"</Link></span>
                </li>
                <li className="feed-item">
                  <div className="feed-date">Feb 2</div>
                  <span className="feed-text"><Link>Justin Lee</Link>attended internation conference in <Link to="profile.html">"St.John School"</Link></span>
                </li>
                <li className="feed-item">
                  <div className="feed-date">Apr 13</div>
                  <span className="feed-text"><Link>John Doe</Link> won 1st place in <Link>"Chess"</Link></span>
